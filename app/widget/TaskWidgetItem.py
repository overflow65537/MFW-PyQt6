from PySide6.QtWidgets import QWidget, QListWidgetItem, QHBoxLayout, QApplication, QSizePolicy
...
class TaskListItem(QWidget):
    ...
    def initUI(self):
        ...
        # 复选框
        self.checkbox = CheckBox(self.config["name"])
        #设置宽度占用最小
        self.checkbox.setSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        #设置占用所有剩余空间
        self.placeholder_label.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
