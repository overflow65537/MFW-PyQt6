...
class OptionWidget(QWidget):
    ...
    def _populate_saved_device(self, saved_options: dict, controller_name: str):
        ...
        if controller_type == "adb":
            ...
            adb_device_name_new = str(flattened_options.get("adb_device_name", ""))
            device_name_old = str(flattened_options.get("device_name", ""))
            ...
            device_data = {
                ...
                "adb_path": adb_path,
                "address": adb_address,
                "screencap_methods": int(str(flattened_options.get("adb_screenshot_method", "0")) or "0"),
                "input_methods": int(str(flattened_options.get("adb_input_method", "0")) or "0"),
                "config": {}
            }
            ...
            # 优先使用新的独立字段，如果没有则回退到旧的共享字段（兼容旧配置）
            device_name = str(flattened_options.get("win32_device_name", "")) or str(flattened_options.get("device_name", ""))
