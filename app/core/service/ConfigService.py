...
class JsonConfigRepository:
    ...
    def __init__(
        ...
        if not self.main_config_path.exists():
            ...
            self.SaveMainConfig(default_main_config)

    def LoadMainConfig(self) -> Dict[str, Any]:
        """加载主配置"""
        try:
    ...
    def SaveMainConfig(self, config_data: Dict[str, Any]) -> bool:
        """保存主配置"""
        try:
...
class ConfigService:
    ...
    def load_main_config(self) -> bool:
        """加载主配置"""
        try:
            self._main_config = self.repo.LoadMainConfig()
            return True
        except Exception as e:
            print(f"加载主配置失败: {e}")
            return False
    ...
    def save_main_config(self) -> bool:
        ...
        return self.repo.SaveMainConfig(self._main_config)
    ...
    def current_config_id(self, value: str) -> bool:
        ...
        if self.save_main_config():
            ...
            self.signal_bus.ConfigChanged.emit(value)
            return True
