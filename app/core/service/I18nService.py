...
class I18nService:
    ...
    def translate_any(self, data: Any, language: Optional[str] = None) -> Any:
        ...
        return data
            ...
            LoadTranslationsFromInterface = load_translations_from_interface
            TranslateLabel = translate_label
...
GetI18nService = get_i18n_service


__all__ = ["I18nService", "get_i18n_service", "GetI18nService"]
